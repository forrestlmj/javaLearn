...
--
-- Host: 172.20.120.180    Database: fintax_account_0
-- ------------------------------------------------------
...
--
-- Current Database: `fintax_account_0`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `fintax_account_0` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `fintax_account_0`;
...
) ENGINE=InnoDB AUTO_INCREMENT=901105787398557706 DEFAULT CHARSET=utf8 COMMENT='科目余额历史表';
...
--
-- Table structure for table `init_dzgs_type`
--

DROP TABLE IF EXISTS `init_dzgs_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `init_dzgs_type` (
  `id` bigint(20) NOT NULL COMMENT '主键',
  `gs_id` bigint(20) DEFAULT NULL COMMENT '代账公司id',
  `user_id` bigint(20) DEFAULT NULL COMMENT '登陆用户id',
  `type` bigint(2) DEFAULT NULL COMMENT '初始化类型',
  `sfchcrkd` tinyint(1) DEFAULT '0' COMMENT '存货是否生成出入库单',
  `kqlszq` tinyint(1) DEFAULT '1' COMMENT '是否开启历史账期标识 0:不开启 1:开启',
  `data_deal_type` tinyint(1) DEFAULT '0' COMMENT '数据处理标识 0:正常迁移 1:删除无发生额科目',
  `create_user` bigint(20) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_user` bigint(20) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `model_name` varchar(64) DEFAULT NULL COMMENT '软件名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='初始化类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `init_slye_temp` (
  ...
  `kjqj` int(2) DEFAULT NULL COMMENT '会计期间',
  `kmid` bigint(20) DEFAULT NULL COMMENT '科目id',
  `kmmc` varchar(1024) DEFAULT NULL COMMENT '科目名称',
  `kmbm` varchar(20) DEFAULT NULL COMMENT '科目编码',
  `jfsl` decimal(32,8) DEFAULT NULL COMMENT '借方发生数量',
...
CREATE TABLE `init_zt_temp` (
  ...
  `sfchcrkd` tinyint(1) DEFAULT '0' COMMENT '存货是否生成出入库单',
  `data_deal_type` tinyint(1) DEFAULT NULL COMMENT '数据处理标识 0:正常迁移 1:删除无发生额科目',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
--
-- Table structure for table `pz_move_dz_id_2021_07_16`
--

DROP TABLE IF EXISTS `pz_move_dz_id_2021_07_16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pz_move_dz_id_2021_07_16` (
  `id` bigint(20) NOT NULL COMMENT '主键',
  `old_pz_id` varchar(40) DEFAULT NULL COMMENT '老凭证',
  `ztdm` bigint(20) DEFAULT NULL COMMENT '账套代码',
  `new_pz_id` bigint(20) DEFAULT NULL COMMENT '新凭证id',
...
) ENGINE=InnoDB AUTO_INCREMENT=7001 DEFAULT CHARSET=utf8 COMMENT='系统行业科目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_hykmdz` (
  ...
  KEY `KJHSZZ_HYID_INDEX` (`KJHSZZ`,`HYID`)
) ENGINE=InnoDB AUTO_INCREMENT=6002 DEFAULT CHARSET=utf8 COMMENT='系统行业科目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_km_pz` (
  ...
  PRIMARY KEY (`ID`),
  KEY `KJHSZZ_INDEX` (`KJHSZZ`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8 COMMENT='科目系统配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_kmbq` (
  ...
  `UPDATE_TIME` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=502 DEFAULT CHARSET=utf8 COMMENT='科目标签表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_kmcjbq` (
  ...
  PRIMARY KEY (`ID`),
  KEY `KJHSZZ_INDEX` (`KJHSZZ`)
) ENGINE=InnoDB AUTO_INCREMENT=3890 DEFAULT CHARSET=utf8 COMMENT='标签对应科目级次表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_kmtjbq` (
  ...
  PRIMARY KEY (`ID`),
  KEY `KJHSZZ_INDEX` (`KJHSZZ`)
) ENGINE=InnoDB AUTO_INCREMENT=2719 DEFAULT CHARSET=utf8 COMMENT='标签推荐表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_zd` (
  ...
  PRIMARY KEY (`ID`),
  KEY `TYPE_IDX` (`TYPE`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='数据字典';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `voucher_detail_record`
--

DROP TABLE IF EXISTS `voucher_detail_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `voucher_detail_record` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `ztdm` bigint(20) DEFAULT NULL COMMENT '账套代码',
  `pz_id` bigint(20) DEFAULT NULL COMMENT '凭证id',
  `pzx_id` bigint(20) DEFAULT NULL COMMENT '凭证id',
  `js_record` char(255) DEFAULT NULL COMMENT '计算记录',
  `item` varchar(10) DEFAULT NULL COMMENT '预留字段',
  `item1` varchar(20) DEFAULT NULL COMMENT '预留字段2',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `index` (`ztdm`,`pz_id`)
) ENGINE=InnoDB AUTO_INCREMENT=901128078735876098 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='凭证明细记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `voucher_detail_record_copy1`
--

DROP TABLE IF EXISTS `voucher_detail_record_copy1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `voucher_detail_record_copy1` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `ztdm` bigint(20) DEFAULT NULL COMMENT '账套代码',
  `pz_id` bigint(20) DEFAULT NULL COMMENT '凭证id',
  `pzx_id` bigint(20) DEFAULT NULL COMMENT '凭证id',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `index` (`ztdm`,`pz_id`)
) ENGINE=InnoDB AUTO_INCREMENT=875676822591082498 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='凭证明细记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `voucher_detail_record_copy2`
--

DROP TABLE IF EXISTS `voucher_detail_record_copy2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `voucher_detail_record_copy2` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `ztdm` bigint(20) DEFAULT NULL COMMENT '账套代码',
  `pz_id` bigint(20) DEFAULT NULL COMMENT '凭证id',
  `pzx_id` bigint(20) DEFAULT NULL COMMENT '凭证id',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `index` (`ztdm`,`pz_id`)
) ENGINE=InnoDB AUTO_INCREMENT=875677295683846147 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='凭证明细记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `zt_check_config`
--

DROP TABLE IF EXISTS `zt_check_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zt_check_config` (
  `ID` bigint(20) NOT NULL,
  `ZTDM` bigint(20) NOT NULL COMMENT '账套代码',
  `KJND` int(4) DEFAULT NULL COMMENT '会计年度',
  `KJQJ` int(4) DEFAULT NULL COMMENT '会计期间',
  ...
  PRIMARY KEY (`ID`),
  KEY `ZTDM_index` (`ZTDM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='账套结账检查配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-10-22 15:21:17
