...
# 1、类加载相关
# 查看类加载情况
jstat -class -t -h5 9265 1s 100
# 查看 元空间情况 Displays statistics about the sizes of the metaspace.
jstat -gcmetacapacity  -t -h5 9265 1s 100
...
# 查看 每个区的最大容量
jstat -gccapacity -t -h5 PID 1s 100 >> AddByteData_jstat_gccapacity.log
# 查看 按照比例 查看堆区的比例
jstat -gcutil -t -h5 44472 1s 100 >> AddByteData_jstat_gcutil.log
#
