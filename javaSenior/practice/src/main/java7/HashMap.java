 ...
 * unsynchronized and permits nulls.和 HashTable 差不多，即使这个线程不安全)
 ...
 * 主要有 初始大小和 装载因子 两个参数影响hashmap的性能。
 * The
 ...
 * current capacity, the hash table is <i>rehashed</i>
 * 重新hash
