...
public interface MysqlDataDictRepository extends JpaRepository<FdsMysqlDataDict,Integer> {
    ...
    @Query("select distinct new com.yzf.di.entity.po.FdsMysqlDataDict(mysqlSourceId,instance,tableSchema,tableName,tableRows,tableComment) from FdsMysqlDataDict a")
