...
--
-- Host: 172.16.120.181    Database: fintax_task_0
-- ------------------------------------------------------
...
--
-- Table structure for table `task_ack_record`
--

DROP TABLE IF EXISTS `task_ack_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `task_ack_record` (
  `id` bigint(20) NOT NULL,
  `task_id` bigint(20) DEFAULT NULL,
  `qy_id` bigint(20) DEFAULT NULL,
  `data_ack_status` tinyint(4) DEFAULT NULL COMMENT '数据ack: 未进行数据ack,2:成功，3失败',
  `condition_ack_status` tinyint(4) DEFAULT NULL COMMENT '状态ack：0未进行ack，2:成功。3失败',
  `retry_count` int(3) DEFAULT NULL COMMENT '重试次数',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `qyId_taskId` (`qy_id`,`task_id`) USING BTREE
...
CREATE TABLE `task_config_black_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14651 DEFAULT CHARSET=utf8 COMMENT='任务黑名配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='任务控制配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `task_config_path`
--

DROP TABLE IF EXISTS `task_config_path`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `task_config_path` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `area_code` char(4) DEFAULT NULL COMMENT '地区编码',
  `gs_id` bigint(20) DEFAULT NULL COMMENT '公司ID',
  ...
  `enabled` tinyint(1) NOT NULL DEFAULT '1' COMMENT '启用标志',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=111111887 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='任务路由配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task_config_report_personal_tax` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=605 DEFAULT CHARSET=utf8 COMMENT='个税配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1539230908215722885 DEFAULT CHARSET=utf8 COMMENT='任务控制配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1533845905294229759 DEFAULT CHARSET=utf8 COMMENT='外部数据';
/*!40101 SET character_set_client = @saved_cs_client */;
